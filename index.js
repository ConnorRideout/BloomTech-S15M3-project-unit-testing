...
class Counter {
     ...
     */
    countDown() {
        if (this.curCount === undefined) this.curCount = this.initialNumber
        else if (this.curCount > 0) this.curCount--
...
class Car {
     ...
     * focus.drive(100) // returns 100, gas at 16.66
     * focus.drive(100) // returns 200, gas at 13.33
     * focus.drive(100) // returns 300, gas at 10
     * focus.drive(200) // returns 500, gas at 3.33
     * focus.drive(200) // returns 600 (ran out of gas after 100 miles)
     */
    drive(distance) {
        // ✨ implement
        const gallonsDelta = distance / this.mpg
        const gallonsConsumed = Math.min(this.tank, gallonsDelta)
        this.tank -= gallonsConsumed
        this.odometer += this.mpg * gallonsConsumed
